  ...
  template: `
    <div class="bg-gradient-to-br from-amber-50 to-orange-100 p-4 md:p-8">
      <div class="mx-auto max-w-6xl">
            ...
            <mat-card-content class="p-6">
              <div class="flex items-start space-x-4">
                ...
                <div class="flex-1">
                  ...
                  <p class="text-gray-600 text-sm">Conductor activo</p>
                </div>
              </div>
            </mat-card-content>
          </mat-card>
        ...
        <mat-card
          class="!rounded-2xl !shadow-lg !bg-amber-50 !border !border-amber-200"
        >
          <mat-card-content class="p-4 md:p-6">
            <h3
              class="text-lg md:text-xl font-bold text-amber-800 mb-3 flex items-center"
            >
            ...
            <ul class="space-y-2 text-amber-900">
              <li class="flex items-start">
                <mat-icon
                  class="mr-2 text-amber-600 flex-shrink-0 !text-base md:!text-xl mt-0.5"
                  >arrow_right</mat-icon
                >
                <span class="text-sm md:text-base"
                  >Verifica la lista de pasajeros antes de cada salida</span
                >
              </li>
              <li class="flex items-start">
                <mat-icon
                ...
                >
                <span class="text-sm md:text-base"
                  >Respeta los horarios programados de salida y llegada</span
                >
              </li>
              <li class="flex items-start">
                <mat-icon
                ...
                >
                <span class="text-sm md:text-base"
                  >Actualiza el estado del viaje al completarlo</span
                >
              </li>
              <li class="flex items-start">
                <mat-icon
                ...
                >
                <span class="text-sm md:text-base"
                  >Mantén la seguridad de todos los pasajeros durante el
                  viaje</span
                >
              </li>
            </ul>
