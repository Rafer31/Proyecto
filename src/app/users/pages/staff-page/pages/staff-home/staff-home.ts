  ...
  template: `
    <div class="bg-gradient-to-br from-green-50 to-teal-100 p-4 md:p-8">
      <div class="mx-auto max-w-6xl">
            ...
            <div class="flex items-start gap-4">
              ...
              <div class="flex-1">
                ...
                <p class="text-yellow-800 text-sm md:text-base mb-4">
                  Recibe alertas 15 minutos antes de cada viaje para que no te pierdas ninguno.
                </p>
                <button
                  mat-raised-button
          ...
          <mat-card class="!rounded-2xl !shadow-lg hover:!shadow-xl transition-all cursor-pointer"
            ...
            <mat-card-content class="p-6">
              <div class="flex items-start space-x-4">
                ...
                <div class="flex-1">
                  <h3 class="text-xl font-semibold text-gray-800 mb-2">Viajes de Salida</h3>
            ...
            <mat-card-content class="p-6">
              <div class="flex items-start space-x-4">
                <div class="flex h-14 w-14 items-center justify-center rounded-full bg-orange-100 flex-shrink-0">
                  <mat-icon class="!h-8 !w-8 !text-[32px] text-orange-600">u_turn_left</mat-icon>
                </div>
                <div class="flex-1">
                  <h3 class="text-xl font-semibold text-gray-800 mb-2">Retornos</h3>
                  <p class="text-gray-600 text-sm">
            ...
            <mat-card-content class="p-6">
              <div class="flex items-start space-x-4">
                <div class="flex h-14 w-14 items-center justify-center rounded-full bg-green-100 flex-shrink-0">
                  <mat-icon class="!h-8 !w-8 !text-[32px] text-green-600">badge</mat-icon>
                </div>
                <div class="flex-1">
                  ...
                  @if (loadingOperation()) {
                    <p class="text-gray-500 text-xs italic">Cargando operación...</p>
                  } @else if (operacion()) {
                    <p class="text-green-700 text-sm font-semibold">
                      <mat-icon class="!w-4 !h-4 !text-base align-middle mr-1">location_on</mat-icon>
                      Operación: {{ operacion() }}
                    </p>
                  }
                </div>
          ...
          <mat-card-content class="p-6">
            ...
            <div class="grid gap-3 md:gap-4 md:grid-cols-2">
              <div class="flex items-start space-x-2 md:space-x-3">
                ...
                <div class="min-w-0">
                  <h4 class="font-semibold text-gray-800 text-sm md:text-base">Reservar viajes de Salida</h4>
              ...
              <div class="flex items-start space-x-2 md:space-x-3">
                 <mat-icon class="text-purple-600 flex-shrink-0 !w-6 !h-6 !text-2xl !leading-6">check_circle</mat-icon>
                <div class="min-w-0">
                  <h4 class="font-semibold text-gray-800 text-sm md:text-base">Solicitar retornos</h4>
                  <p class="text-xs md:text-sm text-gray-600">
              ...
              <div class="flex items-start space-x-2 md:space-x-3">
                <mat-icon class="text-purple-600 flex-shrink-0 !w-6 !h-6 !text-2xl !leading-6">check_circle</mat-icon>
                <div class="min-w-0">
                  <h4 class="font-semibold text-gray-800 text-sm md:text-base">Calificar tus viajes</h4>
                  <p class="text-xs md:text-sm text-gray-600">
        ...
        <!-- Tips importantes -->
        <mat-card class="!rounded-2xl !shadow-lg !bg-blue-50 !border !border-blue-200">
          <mat-card-content class="p-4 md:p-6">
            <h3 class="text-lg md:text-xl font-bold text-blue-800 mb-3 flex items-center">
              <mat-icon class="mr-2 !text-xl md:!text-2xl">tips_and_updates</mat-icon>
              Consejos importantes
            </h3>
            <ul class="space-y-2 text-blue-900">
              <li class="flex items-start">
                <mat-icon class="mr-2 text-blue-600 flex-shrink-0 !text-base md:!text-xl mt-0.5">arrow_right</mat-icon>
                <span class="text-sm md:text-base">Reserva tus viajes con anticipación para asegurar tu lugar</span>
              </li>
              <li class="flex items-start">
                <mat-icon class="mr-2 text-blue-600 flex-shrink-0 !text-base md:!text-xl mt-0.5">arrow_right</mat-icon>
                <span class="text-sm md:text-base">Verifica los horarios de salida antes de cada viaje</span>
              </li>
              <li class="flex items-start">
                <mat-icon class="mr-2 text-blue-600 flex-shrink-0 !text-base md:!text-xl mt-0.5">arrow_right</mat-icon>
                <span class="text-sm md:text-base">Mantén activas las notificaciones para no perderte ningún viaje</span>
              </li>
            </ul>
          </mat-card-content>
        </mat-card>
