...
export class AdminPage {
  ...
  menu: NavItem[] = [
    ...
    { icon: 'airport_shuttle', label: 'Empresas Contratistas', route: '/users/admin/bus-company' },
    { icon: 'groups', label: 'Gestionar usuarios', route: '/users/admin/manage-users' },
    { icon: 'calendar_today', label: 'Planificar viajes', route: '/users/admin/trip-planning' },
  ];
}
