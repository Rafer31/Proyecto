    ...
    <div class="bg-gradient-to-br from-purple-50 to-pink-100 p-4 md:p-8">
      <div class="mx-auto max-w-7xl">
        ...
        <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-4 mb-8">
          ...
          >
            <mat-card-content class="p-6">
              <div class="flex flex-col items-center text-center">
                <div
                  class="flex h-16 w-16 items-center justify-center rounded-full bg-blue-100 mb-3"
                >
                  <mat-icon class="!h-10 !w-10 !text-[40px] text-blue-600"
                    >bar_chart</mat-icon
                  >
                </div>
          ...
          >
            <mat-card-content class="p-6">
              <div class="flex flex-col items-center text-center">
                <div
                  class="flex h-16 w-16 items-center justify-center rounded-full bg-green-100 mb-3"
                >
                  <mat-icon class="!h-10 !w-10 !text-[40px] text-green-600"
          ...
          >
            <mat-card-content class="p-6">
              <div class="flex flex-col items-center text-center">
                <div
                  class="flex h-16 w-16 items-center justify-center rounded-full bg-orange-100 mb-3"
                >
                  <mat-icon class="!h-10 !w-10 !text-[40px] text-orange-600"
                    >people</mat-icon
                  >
                </div>
                <h3 class="text-lg font-semibold text-gray-800 mb-1">
          ...
          >
            <mat-card-content class="p-6">
              <div class="flex flex-col items-center text-center">
                <div
                  class="flex h-16 w-16 items-center justify-center rounded-full bg-purple-100 mb-3"
                >
                  <mat-icon class="!h-10 !w-10 !text-[40px] text-purple-600"
                    >event_note</mat-icon
                  >
                </div>
                <h3 class="text-lg font-semibold text-gray-800 mb-1">
                ...
                <p class="text-gray-600 text-sm">Planifica viajes y horarios</p>
              </div>
            </mat-card-content>
          </mat-card>
        </div>
        ...
        <div class="grid gap-6 md:grid-cols-3 mb-8">
          ...
          >
            <mat-card-content class="p-6">
              ...
              <div class="space-y-3">
                <button
                  mat-stroked-button
                  class="w-full !text-white !border-white"
                  (click)="navigateTo('/users/admin/manage-users')"
                >
          ...
          <mat-card
            class="!rounded-2xl !shadow-lg !bg-gradient-to-br !from-green-500 !to-green-600 !text-white"
          >
            <mat-card-content class="p-6">
          ...
          <mat-card
            class="!rounded-2xl !shadow-lg !bg-gradient-to-br !from-purple-500 !to-purple-600 !text-white"
          >
            <mat-card-content class="p-6">
        ...
        >
          <mat-card-content class="p-4 md:p-6">
            <h3
              class="text-lg md:text-xl font-bold text-purple-800 mb-3 flex items-center"
            >
            ...
            <ul class="space-y-2 text-purple-900">
              <li class="flex items-start">
                <mat-icon
                  class="mr-2 text-purple-600 flex-shrink-0 !w-5 !h-5 !text-xl !leading-5"
                  >arrow_right</mat-icon
                >
                <span class="text-sm md:text-base"
                  >Revisa regularmente las estadísticas para identificar
                  tendencias</span
                >
              </li>
              <li class="flex items-start">
                ...
                >
                <span class="text-sm md:text-base"
                  >Mantén actualizados los datos de empresas y vehículos</span
                >
              </li>
              <li class="flex items-start">
                <mat-icon
                ...
                >
                <span class="text-sm md:text-base"
                  >Planifica los viajes con anticipación para mejor
                  organización</span
                >
              </li>
              <li class="flex items-start">
                ...
                >
                <span class="text-sm md:text-base"
                  >Monitorea el estado de los usuarios y sus actividades</span
                >
              </li>
            </ul>
          </mat-card-content>
